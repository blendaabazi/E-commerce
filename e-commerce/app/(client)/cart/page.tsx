...
//                         className="w-full bg-black text-white rounded-full font-semibold tracking-wide hover:bg-gray-800 transition"
//   size="lg"
//                       >
//                         Proceed to Checkout
//                       </Button>
                  ...
                  <div className="hidden md:inline-block w-full bg-white p-6 rounded-lg border">
                    ...
                    <div className="space-y-4">
                      ...
                      <Button
                        disabled={loading}
                        onClick={handleCheckout}
                        className="bg-black w-full rounded-full font-semibold tracking-wide"
                        size="lg"
                      >
                        Proceed to Checkout
                      </Button>
