...
import { useRequireUser } from "@/hooks/requiredUser";// custom hook
...
export default function UserListClient({ initialUsers }: { initialUsers: User[] }) {
  ...
  // Ndërkohë që po verifikohet përdoruesi, shfaq loading
  if (!user) {
    return <p>Duke verifikuar aksesin...</p>;
  }
        ...
        {users.map((u) => (
          ...
          >
            <div className="flex-grow">
              ...
              <p>
                <strong>Email:</strong> {u.emailAddresses[0]?.emailAddress}
              </p>
              ...
              <p>
                <strong>Roli:</strong> {u.publicMetadata?.role ?? "user"}
              </p>
            </div>
